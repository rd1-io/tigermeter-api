...
Данные (timestamp, цена) показываются без цветовой индикации (монохром), нижняя строка заменена статусом «НЕТ СЕТИ (ПОВТОР…)». Левая панель: иконка Wi‑Fi. Статус-столбец монохромный (чёрный). Портфолио строка скрыта. Возврат к обычному экрану после успешного heartbeat.
